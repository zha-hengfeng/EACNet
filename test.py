    ...
    # Get the best test result among the last 10 model records.
        ...
        if args.checkpoint:
            if os.path.isfile(args.checkpoint):
                ...
                mIOU_val = []
                per_class_iu = []
                for i in range(epoch - 19, epoch + 1):
                ...
                #index = list(range(1, 100))[np.argmax(mIOU_val)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="RACNet_PAM", help="[DABNet, DAB_APN, ParallelDABNet, SEDAB_APNNet]")

    parser.add_argument('--dataset', default="cityscapes", help="dataset: cityscapes or camvid")
    parser.add_argument('--num_workers', type=int, default=1, help="the number of parallel threads")
    parser.add_argument('--batch_size', type=int, default=1,
                        help=" the batch_size is set to 1 when evaluating or testing")
    parser.add_argument('--checkpoint', default="./checkpoint/cityscapes/DABNet_PAM/bs8_gpu1_train_adam/model_300.pth")
