...
def train_model(args):
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        # validation
        if epoch % 25 == 0 or epoch == (args.max_epochs - 1):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="RACNet_PAM",
                        help="[DABNet, DAB_APN, RACNet_PAM, RACNet, ParallelDABNet, SEDABNet, SEDAB_APNNet, DARBNet]")
    ...
    parser.add_argument('--reload', type=str,
                        default="./checkpoint/cityscapes/Author_GitHub_model/DABNet_cityscapes.pth",
