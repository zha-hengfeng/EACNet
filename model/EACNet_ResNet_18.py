...
class EACNet_ResNet_18(nn.Module):
    def __init__(self, num_classes=19, encoder_only=False):
        super(EACNet_ResNet_18, self).__init__()
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False)   # 第一次下采样
        # add by @zhA
        # self.conv1 = nn.Sequential(
