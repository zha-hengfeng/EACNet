...
class Light_PAM_Module(nn.Module):
    """ Position attention module"""
    #Ref from DANet
    def __init__(self, in_dim, out_dim):
        super(Light_PAM_Module, self).__init__()
...
class EACNet(nn.Module):
    def __init__(self, classes=19, block_1=3, block_2=6):
        ...
        self.downsample_2 = DownSamplingBlock(64 + 3, 128)
        ...
        self.classifier = nn.Sequential(Conv(128+3, classes, 1, 1, padding=0))
        #self.pam = Light_PAM_Module(classes, classes)
